		...
		switch (method) {
			case 'GET':
				mssql.connect(dbserver.dbConfig, (err) => {
					...
					const query = `EXEC [dbo].[ProjectTaskProgress_SelectByDate]
          '${selectedDate}', ${projectID} `;
			...
			case 'POST':
				mssql.connect(dbserver.dbConfig, (err) => {
					...
					const query = `EXEC [dbo].[ProjectTaskProgress_Insert]
          ...
          */
			...
			case 'PUT':
				mssql.connect(dbserver.dbConfig, (err) => {
					...
					const query = `EXEC [dbo].[ProjectTaskProgress_DeleteAndInsert]
            ${body.TaskID}, '${body.Date}', '${body.WorkCompleted}'`;
					/* --Params--
            @taskID int,
            @date int,
