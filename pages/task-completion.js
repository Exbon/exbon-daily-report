...
const Task = () => {
		...
		if (id === 'License') {
			return (
				<div className={styles['table__trade-wrapper']}>
					<span className={styles['table__trade-wrapper__data']}>
						{value}
					</span>
				</div>
			);
			...
			return (
				<div className={styles['table__previous-work-wrapper']}>
					<span
						className={styles['table__previous-work-wrapper__data']}
					>
						{value} %
					</span>
				</div>
			...
			return (
				<div className={styles['table__current-work-wrapper']}>
					<span
						className={styles['table__current-work-wrapper__data']}
					>
						{value === null ? (
							<input
								className={
									styles[
										'table__current-work-wrapper__input__previous-work'
									]
								}
								value={previousWork}
								type="number"
							...
							<input
								className={
									styles[
										'table__current-work-wrapper__input__current-work'
									]
								}
								value={value}
								type="number"
	...
	const handleSaveBtn = () => {
		...
		data.forEach((element, index) => {
			if (
				new Date(element.ReqStartDate) > new Date(element.ReqFinishDate)
			) {
			...
			toast.error(
				<div className={styles['alert__complete']}>
					...
					<p style={{ marginBottom: '20px' }}>
						Request Start Date <strong>CANNOT BE LATER </strong>than
						Request Finish Date.
					</p>
	...
	const requestNoWorkDays = (type) => {
		if (
			new Date(modalSaveNoWork.StartDate) >
			new Date(modalSaveNoWork.FinishDate)
		) {
			toast.error(
				<div className={styles['alert__complete']}>
                  ...
                  (This is a test, so NOT working yet. )
											...
											>
												<h4
													className={
														styles[
															'modal-no-work__wrapper-title__title'
														]
													}
												>
													Set No Work Days
											...
											>
												<table
													className={
														styles[
															'modal-no-work__wrapper-table__table'
														]
													}
												>
													<thead>
												...
												<div
													className={
														styles[
															'modal-no-work__wrapper-btn-close'
														]
													}
												>
													<Button
										...
										>
											<div
												className={
													styles[
														'modal-save-no-work__wrapper-content'
													]
												}
											>
												<h4
													className={
														styles[
															'modal-save-no-work__wrapper-content__title'
														]
													}
												>
												...
												>
													...
													>
														<DatePicker
															...
															value={
																modalSaveNoWork.StartDate
															}
															onChange={
																handleStartDateOfSaveNoWork
															}
															format="MM/dd/yyyy"
															label="Start Date"
															className={
														...
														<DatePicker
															...
															value={
																modalSaveNoWork.FinishDate
															}
															onChange={
																handleEndDateOfSaveNoWork
															}
															format="MM/dd/yyyy"
															label="End Date"
															className={
											...
											<div
												className={
													styles[
														'modal-save-no-work__wrapper-content__bottom'
													]
												}
											>
												<div
												...
												>
													<TextField
														...
														rows={2}
														onChange={
															handleReasonOfSaveNoWork
														}
														value={
															modalSaveNoWork.Reason ||
															''
														}
														variant="outlined"
														fullWidth
							...
							>
								<div
									className={
										styles['modal-work-date__wrapper']
									}
								>
									<div
										className={
											styles[
												'modal-work-date__wrapper-title'
											]
										}
									>
										<h4
											className={
												styles[
													'modal-work-date__wrapper-title__title'
												]
											}
										>
											Change Task Date
									...
									<div
										className={
											styles[
												'modal-work-date__wrapper-date-picker'
											]
										}
									>
										<h4
											className={
												styles[
													'modal-work-date__wrapper-date-picker__label'
												]
											}
										>
											{modalWorkDate.type}
									...
									>
										<Button
											...
											className={
												styles[
													'modal-work-date__wrapper-btn__btn-request'
												]
											}
										>
											Request
										...
										<Button
											...
											className={
												styles[
													'modal-work-date__wrapper-btn__btn-cancel'
												]
											}
										>
											Cancel
